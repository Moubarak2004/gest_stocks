...
<nav id="sidebar">
    ...
    <div style="padding: 1rem 0.5rem; margin-top: 1rem; border-top: 1px solid rgba(255,255,255,0.08);">
        <div style="padding: 0.5rem 0.75rem; color: #94a3b8; font-size: 0.8rem;">
